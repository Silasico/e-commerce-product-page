...
imgThumbsShowcase.forEach(function(imgThumbShowcase){
	imgThumbShowcase.addEventListener("click", function(){
		...
		if(imgThumbShowcase.firstElementChild.src.includes("image-product-1-thumbnail.jpg")) {
			pictureNo = 0
			showPicture(productPreviewShowcase)
		}
		if(imgThumbShowcase.firstElementChild.src.includes("image-product-2-thumbnail.jpg")) {
			pictureNo = 1
			showPicture(productPreviewShowcase)
		}
		if(imgThumbShowcase.firstElementChild.src.includes("image-product-3-thumbnail.jpg")) {
			pictureNo = 2
			showPicture(productPreviewShowcase)
		}
		if(imgThumbShowcase.firstElementChild.src.includes("image-product-4-thumbnail.jpg")) {
			pictureNo = 3
			showPicture(productPreviewShowcase)
		}
	})
...
imgThumbs.forEach(function(imgThumb){
	...
	imgThumb.addEventListener("click", function(){
		...
		if(imgThumb.firstElementChild.src.includes("image-product-1-thumbnail.jpg")) {
			pictureNo = 0
			showPicture(previewProduct)
		}
		if(imgThumb.firstElementChild.src.includes("image-product-2-thumbnail.jpg")) {
			pictureNo = 1
			showPicture(previewProduct)
		}
		if(imgThumb.firstElementChild.src.includes("image-product-3-thumbnail.jpg")) {
			pictureNo = 2
			showPicture(previewProduct)
		}
		if(imgThumb.firstElementChild.src.includes("image-product-4-thumbnail.jpg")) {
			pictureNo = 3
			showPicture(previewProduct)
		}
